...
/*   Updated: 2018/12/19 16:15:27 by flklein          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fractol.h"

static void	ft_tricorn_helper(t_thread *t, t_coord c)
{
	t_complex	p;
	t_complex	new;
	t_complex	old;
...
static void	ft_thunder_helper(t_thread *t, t_coord c, t_complex cst)
{
	t_complex	new;
	t_complex	old;
