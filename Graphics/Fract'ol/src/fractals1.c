...
/*   Updated: 2018/12/19 15:45:34 by flklein          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fractol.h"

static void	ft_mandelbrot_helper(t_thread *t, t_coord c, t_complex *new)
{
	t_complex	p;
	t_complex	old;
...
static void	ft_julia_helper(t_thread *t, t_coord c, t_complex *new,
		t_complex cst)
{
	t_complex	old;
