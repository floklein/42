        ...
        <div id="flex-form">
            ...
            <div id="form-box">
                ...
                <form action="back/password.php" method="post">
                    ...
                    <input required pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d).{8,64}$" minlength="8" maxlength="64" type="password" name="repeat-passwd" <?php if ($error === "pwds_no_match") {?> class="invalid validation" placeholder="Mots de passe différents" <?php } else {?> class="validation" placeholder="Confirmez le mot de passe" <?php }?>><br>
                    <button type="submit" name="password-submit" value="ok" style="margin-bottom: 6px;">Modifier</button>
                </form>
                <p><span>Votre compte.</span></p>
                <a href="back/delete.php"><button class="delete" style="margin-top: 0;">Supprimer mon compte</button></a>
            </div>
