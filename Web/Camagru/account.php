...
<input required type="email" name="email" <?php if ($error === "invalid_email") { ?> class="invalid" placeholder="Adresse email invalide" <?php } else { ?> value="<?= $_SESSION['logged_on_user']['email'] ?>" placeholder="Changez votre adresse email" <?php } ?>><br>
                <input required type="text" name="name" <?php if ($error === "user_exists") { ?> class="invalid" placeholder="Nom d'utilisateur non disponible" <?php } else if ($error === "invalid_username") { ?> class="invalid" placeholder="Nom d'utilisateur invalide" <?php } else { ?> value="<?= $_SESSION['logged_on_user']['login'] ?>" placeholder="Changez votre nom d'utilisateur"><?php } ?><br>
